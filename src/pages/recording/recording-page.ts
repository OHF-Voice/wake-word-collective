    ...
    render() {
        return html`
            ...
            <div class="speak-indicator">
                <p>
                    When the circle turns green, say
                ...
                <p>
                    ${this.times > 0
                        ? html`${this.times} more
                          time${this.times == 1 ? "" : "s"}`
                        : "Keep going if you want to!"}
                </p>
            </div>
            <p class="instructions">
                Say it like you would say it normally. Try putting your device
                down while moving around the room. Occasionally speak softly or
                speak up. Some background noise is useful for training.
            </p>
            <md-filled-button
                @click=${() => {
                    this.recorder.stop();
